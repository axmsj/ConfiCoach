  ...
  return (
    <motion.div
      ...
      <div className='setup-card'>
        ...
        <p className='setup-subtext'>Set up your interview coach before you start chatting.</p>
        ...
        <div className='form-group'>
          ...
          <div className='option-grid'>
            {['Friendly', 'Encouraging', 'Serious', 'Strict'].map((t) => (
              <button
                key={t}
                type='button'
                className={`option-card serious-option${tone === t ? ' selected' : ''}`}
                onClick={() => setTone(t)}>
                {t}
              </button>
            ))}
